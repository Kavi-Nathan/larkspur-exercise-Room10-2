...
TONE_ADDENDUM = (
    " If the customer is abusive or threatens legal action, acknowledge the complaint "
    "once, call escalate_to_human immediately with the threat in your summary, promise "
    "nothing, and do not continue the normal entitlement flow or offer a refund path."
...
def build_tools() -> List[Dict[str, Any]]:                 # ✏️ Build 1, step 1.3
    ...
    return [
        ...
        },
        {
            ...
            "description": (
                "Find viable rebooking options for the disrupted booking, including the "
                "best available alternatives and the seats or dates they offer. Use this "
                "after looking up the reservation to see what can be rebooked next."
            ),
            "input_schema": {
                "type": "object",
